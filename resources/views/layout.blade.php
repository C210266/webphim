                ...
                <div class="collapse navbar-collapse" id="halim">
                    <div class="menu-menu_1-container">
                        <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            <li class="mega dropdown">
                                <a title="Nam phim" href="#" data-toggle="dropdown" class="dropdown-toggle"
                                    aria-haspopup="true">Nam phim<span class="caret"></span></a>
                                <ul role="menu" class=" dropdown-menu">
                    ...
                    $.getJSON('/json_file/movies.json', function(data) {
                        $.each(data, function(key, value) {
                            if (value.title.search(expression) != -1) {
                                $('#result').append(
                                    '<li class="list-group-item" style="cursor:pointer"><image width ="50"height="50" src="/uploads/movie/' +
