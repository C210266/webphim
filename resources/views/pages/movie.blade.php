        ...
        <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
            <section id="content" class="test">
                <div class="clearfix wrap-content">
                        ...
                        <div class="movie_info col-xs-12">
                            <div class="movie-poster col-md-3">
                                ...
                                @if ($movie->resolution != 5)
                                    ...
                                    @endif
                                @else
                                    <a href="#watch_trailer" class="btn btn-primary watch_trailer" style="display:block">Xem
                                        trailer</a>
                                @endif
                            </div>
                            <div class="film-poster col-md-9">
                                ...
                                <ul class="list-info-group">
                                    ...
                                    <li class="list-info-group-item"><span>Tap phim</span> :
                                    ...
                                    <li class="list-info-group-item"><span>Tap phim moi nhat</span> :

                                        @if ($movie->thuocphim == 'phimbo')
                                            @if ($episode_current_list_count > 0)
                                                @foreach ($episode as $key => $ep)
                                                    <a
                                                        href="{{ url('xem-phim/' . $ep->movie->slug . '/tap-' . $ep->episode) }}">{{ $ep->episode }}</a>
                                                @endforeach
                                            @endif
                    ...
                    <!-----Comment phim------->
                    <div class="section-bar clearfix">
                        <h2 class="section-title"><span style="color:#ffed4d">Binh luan phim</span></h2>
                    </div>
                    <div class="entry-content htmlwrap clearfix">
                        <div class="video-item halim-entry-box">
                            <article id="post-38424" class="item-content">
