                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('phude', ['0' => 'Phu de', '1' => 'Thuyet minh'], isset($movie) ? $movie->phude : '', [
                                'class' => 'form-control',
                            ]) !!}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('thuocphim',['phimle'=>'Phim le','phimbo'=>'Phim bo'] , isset($movie) ? $movie->thuocphim : '', [
                                'class' => 'form-control',
                            ]) !!}
                        </div>
